...
---
Mode « 30 jours ». Lis `tio-clem/PLAYBOOK.md`, puis :

1. `python3 tio-clem/tools/factory.py calendar` : lis le calendrier.
...
4. Toutes les 5 publications, relis `tio-clem/content/published.json` et vérifie la variété (hooks, angles, émotions, palettes, CTA).
5. À la fin : `python3 tio-clem/tools/factory.py review all`, puis `python3 tio-clem/tools/factory.py export`.
