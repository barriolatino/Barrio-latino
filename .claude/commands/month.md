...
---
Mode « 30 jours ». Lis `tioclem/PLAYBOOK.md`, puis :

1. `python3 tioclem/factory.py calendar` : lis le calendrier.
...
4. Toutes les 5 publications, relis `tioclem/content/published.json` et vérifie la variété (hooks, angles, émotions, palettes, CTA).
5. À la fin : `python3 tioclem/factory.py review all`, puis `python3 tioclem/factory.py export`.
