...
Pour chacune : `python3 tioclem/factory.py next` donne le prochain jour non produit (le calendrier d'abord, puis la meilleure idée de la banque), puis suis exactement la procédure de `.claude/commands/create-day.md` pour ce jour. Relis `tioclem/content/published.json` avant chaque nouvelle publication pour éviter les répétitions entre elles.
