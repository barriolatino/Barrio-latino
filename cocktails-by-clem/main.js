...
(() => {
  ...
  const SERVICES = [
    ...
    { id: 'mariage',    titre: 'Mariages',
      ...
      img: 'assets/cocktails/pisco-sour.jpg',
      alt: "Illustration du Pisco Sour, servi en réception." },
    { id: 'anniv',      titre: 'Anniversaires',
      ...
      img: 'assets/cocktails/pina-colada.jpg',
      alt: "Illustration de la Piña Colada de la carte." },
    { id: 'pro',        titre: 'Événements professionnels',
      ...
      img: 'assets/cocktails/chilcano.jpg',
      alt: "Illustration du Chilcano de la carte." },
  ...
  const EVENEMENTS = [
    ...
    { nom: 'Événement sur mesure',    type: 'Événement sur mesure',     ico: 'i-sparkle', wide: true }
  ];
